`timescale 1ns / 1ps
    ...
    module CPU(
           ...
           //Program counter instantiation 
            ...
            //Program counter instantiation 
            pc pc_inst (.clk(clk), .reset(reset), .pc_input(mux4_to_pcinput),.pc_output(pc_from_pc_to_IFID));
...
module instructionmemory(
    ...
    //Instructions
      ...
      instructions[24] = 32'b11111000000000001000000101101100; // STUR    x12, [ x11, #8]
